    ...
    public static void menuPpal() {
        ...
        do {
            try {
                ...
                switch (opcion) {
                    case 1 -> menuPolynomialF1();
                    case 2 -> menuPolynomialF2();
                    case 3 -> menuPolista();
                    case 4 -> menuPolinomiosCombinados();
        ...
        do {
            try {
                ...
                switch (opcion) {
                    ...
                    case 2:
                        x = Float.parseFloat(
                                JOptionPane.showInputDialog("Ingrese el valor de la variable"));
                        res = A.evaluate(x);
                        JOptionPane.showMessageDialog(null,
                                "El resultado de evaluate el polinomio es " + res);
                        break;
                    case 3:
                        C = A.add(B);
                        JOptionPane.showMessageDialog(null,
